...
import { fireEvent, render, screen, within } from '../../../../utils/testing/test'
...
describe('SetupInputGroup test (mobile variant)', () => {
    ...
    const selectFloor = (matcher: string, select = getFloorSelector()) =>
        selectMuiSelectOption(select, new RegExp(matcher, 'i'))
